        ...
        <div>
            <div className="flex flex-row">
                ...
                <div className="flex flex-col lg:ml-20 lg:w-[600px] w-full px-5 md:mt-25 mt-10">
                            ...
                            <div key={index} className="relative flex flex-col w-full">
                                ...
                                <div className="bg-white border border-gray-200 rounded-xl flex text-[15px] font-medium hover:border-hovergreen" >
                                    <input
                                        ...
                                        className="rounded-xl  w-full  py-3 sm:py-4 px-4 sm:px-5  md:w-[190px] lg:w-[290px] outline-none placeholder:text-[12px] "
                                        value={signup}
                    ...
                    <div className="w-full py-3 bg-greencol flex justify-center items-center  font-medium  hover:bg-hovergreen rounded-xl mt-10 duration-300 transition ease-in-out">
